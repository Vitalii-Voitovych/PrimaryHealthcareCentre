...
namespace PrimaryHealthcareCentre.PatientClient.MVVM.ViewModel
{
    public class PrescriptionsViewModel
    {
        public ObservableCollection<List<Prescription>> Prescriptions { get; } = new()
        {
            ...
            {
                new Prescription(){ Patient = new Patient("Качмар Р.Р.", "Чоловіча", new DateTime(2002,11,7), "380923232343", "0017284734"), Preparation = new Preparation("Анальгін", 100.0, 10), Date = DateTime.Now },
                new Prescription(){ Patient = new Patient("Качмар Р.Р.", "Чоловіча", new DateTime(2002,11,7), "380923232343", "0017284734"), Preparation = new Preparation("Анальгін", 100.0, 10), Date = DateTime.Now },
                new Prescription(){ Patient = new Patient("Качмар Р.Р.", "Чоловіча", new DateTime(2002,11,7), "380923232343", "0017284734"), Preparation = new Preparation("Анальгін", 100.0, 10), Date = DateTime.Now },
                new Prescription(){ Patient = new Patient("Качмар Р.Р.", "Чоловіча", new DateTime(2002, 11, 7), "380923232343", "0017284734"), Preparation = new Preparation("Анальгін", 100.0, 10), Date = DateTime.Now },
                new Prescription(){ Patient = new Patient("Качмар Р.Р.", "Чоловіча", new DateTime(2002, 11, 7), "380923232343", "0017284734"), Preparation = new Preparation("Анальгін", 100.0, 10), Date = DateTime.Now },
